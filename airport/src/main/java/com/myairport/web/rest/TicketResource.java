...
import com.myairport.service.TicketService;
...
/**
 * REST controller for managing {@link com.myairport.domain.Ticket}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TicketResource {
    ...
    public List<Ticket> getReservedTickets() {
        log.debug("REST request to get all reserved tickets : {}");
        return ticketRepository.getAllReserved();
    }
    
    @PostMapping("/assignFlightToTicket")
    public void connectTicketAndFlight(@Valid @RequestBody FlightAndTicketDTO ftDTO) {
        log.debug("REST request to connect flight with ticket : {}", ftDTO);
        ticketService.addFlightToTicket(ftDTO);
    }
}
